    ...
    func macroAssumingSyncFactory() {
        assertMacro {
            ...
            public class Example {
                ...
                private  let _dependency = LazyInjectedResolver(Container.dependency, file: #file, line: #line, function: #function)
    ...
    func macroAssumingStaticSyncFactory() {
        assertMacro {
            ...
            public class Example {
                ...
                private static let _dependency = LazyInjectedResolver(Container.dependency, file: #file, line: #line, function: #function)
