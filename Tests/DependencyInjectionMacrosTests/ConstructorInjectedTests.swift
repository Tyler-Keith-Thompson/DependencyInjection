...
struct ConstructorInjectedTests {
    @Test(
        .macros(
          ["ConstructorInjected": ConstructorInjectedSyncMacro.self],
    ...
    func macroAssumingSyncFactory() {
        assertMacro {
            ...
            public class Example {
                @ConstructorInjected(Container.dependency) private var dependency: Dependency
            }
            """
        } expansion: {
            """
    ...
    @Test(
        .macros(
          ["ConstructorInjected": ConstructorInjectedSyncThrowingMacro.self],
          record: .never // Record only missing snapshots
        )
    )
    func macroSpecifyingSyncThrowingFactory() {
        assertMacro {
            ...
            public class Example {
                @ConstructorInjected(Container.dependency) private var dependency: Result<Dependency, any Error>
            }
            """
        } expansion: {
            """
    ...
    @Test(
        .macros(
          ["ConstructorInjected": ConstructorInjectedAsyncMacro.self],
          record: .never // Record only missing snapshots
        )
    )
    func macroSpecifyingAsyncFactory() {
        assertMacro {
            ...
            public class Example {
                @ConstructorInjected(Container.dependency) private var dependency: Task<Dependency, Never>
            }
            """
        } expansion: {
            """
    ...
    @Test(
        .macros(
          ["ConstructorInjected": ConstructorInjectedAsyncThrowingMacro.self],
          record: .never // Record only missing snapshots
        )
    )
    func macroSpecifyingAsyncThrowingFactory() {
        assertMacro {
            ...
            public class Example {
                @ConstructorInjected(Container.dependency) private var dependency: Task<Dependency, any Error>
            }
            """
        } expansion: {
            """
    ...
    func macroAssumingStaticSyncFactory() {
        assertMacro {
            ...
            public class Example {
                @ConstructorInjected(Container.dependency) private static var dependency: Dependency
            }
            """
        } expansion: {
            """
